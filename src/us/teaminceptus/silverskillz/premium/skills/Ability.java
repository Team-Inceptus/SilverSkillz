...
public enum Ability {
	...
	private static Map<Ability, List<UUID>> cooldown = new HashMap<>();
	
	private Ability(int id, Skill skill, int skillLevel, String name, Action action, Material icon, String[] description, PotionEffect[] effects, long cooldownTicks) {
		this.id = id;
		this.name = name;
	...
	private Ability(int id, Skill skill, int skillLevel, String name, Material icon, String[] description, long durationTicks, long cooldownTicks) {
		this.id = id;
		this.name = name;
		this.effects = null;
		this.cooldownTicks = cooldownTicks;
	...
	private Ability(int id, Skill skill, int skillLevel, String name, Action action, Material icon, String[] description) {
		this.id = id;
		this.name = name;
		this.effects = null;
	...
	private Ability(int id, Skill skill, int skillLevel, String name, Material icon, String[] description) {
		this.id = id;
		this.name = name;
		this.effects = null;
		this.cooldownTicks = -1;
	...
	private Ability(int id, Skill skill, int skillLevel, String name, Material icon, String[] description, PotionEffect[] effects, long cooldownTicks) {
		this.id = id;
		this.name = name;
		this.effects = effects;
		this.cooldownTicks = cooldownTicks;
	...
	public final ItemStack generateLockedItem() {
		...
		lore.add(ChatColor.LIGHT_PURPLE + "- " + ChatColor.GOLD + this.skill.getCapitalizedName() + ChatColor.AQUA + " Level " + Integer.toString(this.getLevelUnlocked()));
	 ...
	 */
	public void execute(SilverPlayer sp, boolean message) {
	 ...
	 * @param sp Player involved in this ability
	 */
	public final void execute(SilverPlayer sp) {
		execute(sp, false);
	}
	...
	public final ItemStack generateItemStack() {
		...
		itemDesc.add(ChatColor.GRAY + "Unlocked At: " + ChatColor.AQUA + this.skill.getCapitalizedName() + ChatColor.GOLD + " Level " + Integer.toString(this.unlockLevel));
